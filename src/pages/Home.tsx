  ...
  return (
    <main className="page-top">
        ...
        <div className="container">
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroHeading}>
              ...
              <Reveal animation="fade-up" delay={120} duration={900}>
            ...
            <Reveal animation="fade-up" delay={260} duration={800}>
            ...
            <Reveal animation="fade-up" delay={400} duration={800}>
            ...
            <Reveal animation="fade-up" delay={540} duration={800}>
        ...
        <div className="container">
          ...
          <div className={styles.servicesGrid}>
            {featuredServices.map((svc, i) => (
              <Reveal key={svc.id} animation="zoom-up" delay={i * 100} duration={600}>
        ...
        <div className="container">
          ...
          <div className={styles.projectsGrid}>
            {featuredProjects.map((proj, i) => (
              <Reveal key={proj.id} animation="zoom-up" delay={i * 130} duration={700}>
                <div className={`${styles.projectCard} ${i === 0 ? styles.projectCardFeatured : ''}`}>
        ...
        <div className="container">
          ...
          <div className={styles.whyGrid}>
            {whyChooseUs.map((item, i) => (
              <Reveal key={item.title} animation="fade-up" delay={i * 80} duration={600}>
        ...
        <div className="container">
          ...
          <div className={styles.testimonialGrid}>
            {testimonials.map((t, i) => (
              <Reveal key={i} animation="zoom-up" delay={i * 120} duration={700}>
      ...
      <section className={styles.brandSection}>
        ...
        <div className="container">
          <Reveal animation="zoom-in" duration={1000}>
